            ...
            <div id="manual-contents">
                ...
                <div class="manual-item">
                    ...
                    <div id="manual-create" class="manual-content hidden">
                        ...
                        <p class="text-base mb-4">
                            ①「AIで生成」AIでエピソードを生成することができます。生成する際は、5W1H1Dを参照します。何も入力していなくても生成することはできます。<br><br>
                            ②「タイトル」エピソードのタイトルを入力します。必須項目なので、ここを入力せずに保存しようとするとエラーになります。<br>
                            (遊び、ニュース、季節、友達、旅、健康、仕事、学校、家族、恋人、住居、食事)などから考えてみましょう。【例】調子乗りの友達<br><br>
                        </p>
                        <img src="{{ asset('img/manual/new2.png') }}" alt="新規作成設定" class="manual-img-large">
                        <p class="text-base mb-4">
                            ③「いつ？」出来事がいつ起こったか入力します。<br>
                            【例】小学校の掃除時間<br><br>
                            ④「どこで？」出来事がどこで起こったか入力します。<br>
                            【例】教室で<br><br>
                            ⑤「だれが？」行動したのはだれか入力します。<br>
                            【例】トイレットペーパーを全身に巻いた友達が<br><br>
                        </p>
                        <img src="{{ asset('img/manual/new3.png') }}" alt="新規作成設定" class="manual-img-large">
                        <p class="text-base mb-4">
                            ⑥「なにを？」出来事の対象物、対象人物を入力します。<br>
                            【例】先生を<br><br>
                            ⑦「どうした？」どのような行動をしたのか、何が起こったのかを入力します。<br>
                            【例】怒らせた<br><br>
                            ⑧「なぜ？」出来事が起こった理由、行動した理由を入力します。<br>
                            【例】間違って先生を驚かしたから<br><br>
                        </p>
                        <img src="{{ asset('img/manual/new4.png') }}" alt="新規作成設定" class="manual-img-large">
                        <p class="text-base mb-4">
                            ⑨「どのように？」出来事や行動がどのように成されたか入力します。<br>
                            【例】掃除用具入れから飛び出してきて<br><br>
                            ⑩「共感ポイント？」この話の中で、聞き手に共感してほしい、面白いと思ったポイントや感情を入力します。<br>
                            【例】友達が調子に乗って、罰が当たるところ<br><br>
                            ⑪「5W1H1Dまとめ」5W1H1Dに入力した内容が、自動的に結合されてここに表示されます。<br><br>
                        </p>
                        <img src="{{ asset('img/manual/new5.png') }}" alt="新規作成設定" class="manual-img-large">
                        <p class="text-base mb-4">
                            ⑫「起(フリ：導入)」話の導入。話を聞いてもらう上で必要な情報を入力します。<br>
                            【例】小学生のころ、すごく調子乗りな友達がいた。<br><br>
                            ⑬「承(フリ：起の情報を深める)」「起」の情報を深める情報を入力します。<br>
                            【例】「女子だけ体育館に集合」ってときに、こっそりついて行って怒られるようなお調子者だった。<br><br>
                            ⑭「転(フリ：話の山場。聞き手の興味関心を惹く)」話の山場となる部分を入力します。<br>
                            【例】ある日の掃除時間、その友達はトイレットペーパーを全身に巻いて掃除用具入れに隠れていた。何も知らない先生がやってきて掃除用具入れを開けた。<br><br>
                            ⑮「結(オチ：最終的にどうなったか)」結末、オチを入力します。<br>
                            【例】するとその友達が飛び出してきて、先生ビックリ！友達はこっぴどく怒られた。<br><br>
                        </p>
                        <img src="{{ asset('img/manual/new6.png') }}" alt="新規作成設定" class="manual-img-large">
                        <p class="text-base mb-4">
                            ⑯「起承転結の内容を反映」このボタンを押すと、起承転結の内容を結合して下のエピソード欄に反映します。<br><br>
                            ⑰「エピソード欄」エピソード本体になります。必須項目です。これまでで作成した内容を確認し、補足や脚色を入れて清書します。<br><br>
                            ⑱「公開状態」エピソードを他のユーザーに公開するか、公開しないかを選びます。公開するとランキングにも参加できます。<br><br>
                            ⑲「投稿する」エピソードを保存します。<br><br>
                        </p>
