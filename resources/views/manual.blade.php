                ...
                <div class="manual-item">
                    ...
                    <div id="manual-syousai" class="manual-content hidden">
                        ...
                        <p class="text-base mb-4">
                            ...
                            ④「いいね」<br>エピソードにいいねすることができます。いいねをするとハートマークが赤くなります。<br><br>
                            ⑤「Xで共有」<br>自分で作成したエピソードの場合のみ、このボタンが表示されます。Xで共有してポストすることができます。<br><br>
                            ⑥「コメント」<br>エピソードにコメントすることができます。コメント入力欄に入力し、「コメントする」ボタンを押します。<br><br>
                        </p>
                        <img src="{{ asset('img/manual/syousai2.png') }}" alt="エピソード詳細" class="manual-img-large">
                        <p class="text-base mb-4">
                            ⑦「エピソード詳細」<br>エピソード作成時の詳細を確認できます。<br><br>
                        </p>
